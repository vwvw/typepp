...
static const LOWFAT_CONST_DATA size_t lowfat_magics[] =
{
	...
	0x0000000040000001ull, /* idx=61, size=17179869184 */
};
...
const LOWFAT_CONST_DATA ssize_t lowfat_stack_offsets[64+1] =
{
	...
	0, /* idx=37 */
	0, /* idx=38 */
	-687194767360,	/* idx=39, size=33554432 */
	-755914244096,	/* idx=40, size=16777216 */
	-824633720832,	/* idx=41, size=8388608 */
	-893353197568,	/* idx=42, size=4194304 */
	-962072674304,	/* idx=43, size=2097152 */
	-1030792151040,	/* idx=44, size=1048576 */
	-1099511627776,	/* idx=45, size=524288 */
	-1168231104512,	/* idx=46, size=262144 */
	-1236950581248,	/* idx=47, size=131072 */
	-1305670057984,	/* idx=48, size=65536 */
	-1374389534720,	/* idx=49, size=32768 */
	-1443109011456,	/* idx=50, size=16384 */
	-1717986918400,	/* idx=51, size=8192 */
	-2061584302080,	/* idx=52, size=4096 */
	-2405181685760,	/* idx=53, size=2048 */
	-2748779069440,	/* idx=54, size=1024 */
	-3092376453120,	/* idx=55, size=512 */
	-3435973836800,	/* idx=56, size=256 */
	-3779571220480,	/* idx=57, size=128 */
	-4054449127424,	/* idx=58, size=64 */
	-4191888080896,	/* idx=59, size=32 */
	-4260607557632,	/* idx=60, size=16 */
	-4260607557632,	/* idx=61, size=16 */
	-4260607557632,	/* idx=62, size=16 */
	-4260607557632,	/* idx=63, size=16 */
	-4260607557632,	/* idx=64, size=16 */
};
	...
	switch (__builtin_clzll(size))
	{
		...
		case 39:
			if (size <= 16777216-1-3)
				return 52;
		case 38:
			if (size <= 33554432-1-6)
				return 53;
		case 37:
			if (size <= 67108864-1-13)
				return 54;
		case 36:
			if (size <= 134217728-1-28)
				return 55;
		case 35:
			if (size <= 268435456-1-57)
				return 56;
		case 34:
			if (size <= 536870912-1-116)
				return 57;
		case 33:
			if (size <= 1073741824-1-236)
				return 58;
		case 32:
			if (size <= 2147483648-1-480)
				return 59;
		case 31:
			if (size <= 4294967296-1-976)
				return 60;
		case 30:
			if (size <= 8589934592-1-1987)
				return 61;
		case 29:
			if (size <= 17179869184-1-4047)
				return 62;
		case 28:
		case 27:
		case 26:
