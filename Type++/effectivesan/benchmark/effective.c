...
EFFECTIVE_HOT EFFECTIVE_BOUNDS effective_type_check_simple(
    const EFFECTIVE_TYPE *t, const EFFECTIVE_TYPE *u)
{
    void *ptr = 0x0;
    size_t idx = 0;
    void* base = 0x0;
    ...
    // EFFECTIVE_BOUNDS bases = {0, 0};
    // EFFECTIVE_BOUNDS sizes = {0, meta->size};
    EFFECTIVE_BOUNDS sizes = {0, 64};
